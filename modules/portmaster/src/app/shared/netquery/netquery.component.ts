...
import { ChartResult, Condition, Database, FeatureID, IPScope, Netquery, NetqueryConnection, OrderBy, PossilbeValue, Query, QueryResult, SPNService, Select, Verdict } from "@safing/portmaster-api";
